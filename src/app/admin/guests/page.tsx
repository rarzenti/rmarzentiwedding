  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-emerald-50 to-sky-50 py-8">
      ...
      <div className="mb-8 px-4">{/* Header */}
        <Link 
          href="/admin"
          className="inline-flex items-center text-gray-700 hover:text-gray-900 mb-4 font-cormorant font-medium"
        >
      ...
      <div className="mb-8 px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">{/* Stats Cards */}
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
            <div className="text-2xl font-playfair font-semibold text-gray-900">{guestStats.total}</div>
            <div className="text-sm font-cormorant text-gray-700">Total Guests</div>
          </div>
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
            <div className="text-2xl font-playfair font-semibold text-emerald-700">{guestStats.confirmed}</div>
            <div className="text-sm font-cormorant text-gray-700">Confirmed</div>
          </div>
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
            <div className="text-2xl font-playfair font-semibold text-red-700">{guestStats.declined}</div>
            <div className="text-sm font-cormorant text-gray-700">Declined</div>
          </div>
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
            <div className="text-2xl font-playfair font-semibold text-amber-700">{guestStats.pending}</div>
            <div className="text-sm font-cormorant text-gray-700">Pending</div>
          </div>
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
            <div className="text-2xl font-playfair font-semibold text-blue-700">{guestStats.children}</div>
            <div className="text-sm font-cormorant text-gray-700">Children</div>
          </div>
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
            <div className="text-2xl font-playfair font-semibold text-purple-700">{guestStats.withFoodSelection}</div>
            <div className="text-sm font-cormorant text-gray-700">Food Selected</div>
          </div>
        </div>
      </div>
            ...
            <tr>
              ...
              <th className="px-6 py-2">
                <div className="flex flex-col">
                  <span className="font-semibold font-cormorant text-gray-900">Guest</span>
                  <input
                    type="text"
                    value={guestFilter}
              ...
              <th className="px-6 py-2">
                <div className="flex flex-col">
                  <span className="font-semibold font-cormorant text-gray-900">Group</span>
                  <input
                    type="text"
                    value={groupFilter}
              ...
              <th className="px-6 py-2">
                <div className="flex flex-col">
                  <span className="font-semibold font-cormorant text-gray-900">Email</span>
                  <input
                    type="text"
                    value={emailFilter}
              ...
              <th className="px-6 py-2">
                <div className="flex flex-col">
                  <span className="font-semibold font-cormorant text-gray-900">Dietary Restrictions</span>
                  <input
                    type="text"
                    value={dietaryFilter}
              ...
              <th className="px-6 py-2">
                <div className="flex flex-col">
                  <span className="font-semibold font-cormorant text-gray-900">Table</span>
                  <select
                    value={tableFilter}
              ...
              <th className="px-6 py-2">
                <div className="flex flex-col">
                  <span className="font-semibold font-cormorant text-gray-900">Type</span>
                  <select
                    value={typeFilter}
            ...
            {filteredGuests.length === 0 ? (
              <tr>
                <td colSpan={8} className="px-6 py-12 text-center">
                  <div className="text-gray-600 font-cormorant text-lg">
                  ...
                  <td className="px-6 py-4">
                    <div className="font-cormorant">
                      <div className="font-medium text-gray-900">
                        {guest.title && <span className="text-gray-600 mr-1">{guest.title}</span>}
                        {guest.firstName} {guest.lastName}
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="font-cormorant text-gray-900">
